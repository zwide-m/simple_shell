 ...
 * @head_ptr: these are the address of pointer to head node
 *
 * Return: void
 */
...
/**
 * delete_node_at_index - these deletes node at given index
 * @head: this is the address of pointer to first node
 * @index: the index of node to delete
 *
 * Return: successon 1, failure on 0
 */
 ...
 * @head: the address of pointer to head node
 * @str: this is the string field of node
 * @num: the node index used by history
 *
 * Return: size of list
 */
